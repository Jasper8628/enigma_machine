...
class StartTextDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartTextDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartTextDetectionResponse.filterSensitiveLog,
        };
