...
class StartFaceDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartFaceDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartFaceDetectionResponse.filterSensitiveLog,
        };
