...
class DeleteStreamProcessorCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteStreamProcessorRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteStreamProcessorResponse.filterSensitiveLog,
        };
