...
class DescribeCollectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeCollectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeCollectionResponse.filterSensitiveLog,
        };
