...
class StartPersonTrackingCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartPersonTrackingRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartPersonTrackingResponse.filterSensitiveLog,
        };
