...
class GetContentModerationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetContentModerationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetContentModerationResponse.filterSensitiveLog,
        };
