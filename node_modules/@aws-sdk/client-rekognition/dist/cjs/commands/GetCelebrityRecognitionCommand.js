...
class GetCelebrityRecognitionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetCelebrityRecognitionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetCelebrityRecognitionResponse.filterSensitiveLog,
        };
