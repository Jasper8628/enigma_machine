...
class DescribeProjectVersionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeProjectVersionsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeProjectVersionsResponse.filterSensitiveLog,
        };
