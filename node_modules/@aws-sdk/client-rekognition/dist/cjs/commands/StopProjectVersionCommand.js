...
class StopProjectVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StopProjectVersionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StopProjectVersionResponse.filterSensitiveLog,
        };
