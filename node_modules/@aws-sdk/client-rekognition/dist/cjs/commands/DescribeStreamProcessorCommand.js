...
class DescribeStreamProcessorCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeStreamProcessorRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeStreamProcessorResponse.filterSensitiveLog,
        };
