...
class RecognizeCelebritiesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.RecognizeCelebritiesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.RecognizeCelebritiesResponse.filterSensitiveLog,
        };
