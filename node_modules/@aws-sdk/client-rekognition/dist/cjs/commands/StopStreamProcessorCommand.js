...
class StopStreamProcessorCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StopStreamProcessorRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StopStreamProcessorResponse.filterSensitiveLog,
        };
