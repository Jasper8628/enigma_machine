...
class SearchFacesByImageCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.SearchFacesByImageRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.SearchFacesByImageResponse.filterSensitiveLog,
        };
