...
class CreateCollectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateCollectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateCollectionResponse.filterSensitiveLog,
        };
