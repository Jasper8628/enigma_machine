...
class DetectModerationLabelsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DetectModerationLabelsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DetectModerationLabelsResponse.filterSensitiveLog,
        };
