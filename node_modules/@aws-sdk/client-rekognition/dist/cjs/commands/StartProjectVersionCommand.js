...
class StartProjectVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartProjectVersionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartProjectVersionResponse.filterSensitiveLog,
        };
