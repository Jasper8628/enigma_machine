...
class GetSegmentDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetSegmentDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetSegmentDetectionResponse.filterSensitiveLog,
        };
