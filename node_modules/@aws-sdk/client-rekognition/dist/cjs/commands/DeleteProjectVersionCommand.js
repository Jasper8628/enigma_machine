...
class DeleteProjectVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteProjectVersionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteProjectVersionResponse.filterSensitiveLog,
        };
