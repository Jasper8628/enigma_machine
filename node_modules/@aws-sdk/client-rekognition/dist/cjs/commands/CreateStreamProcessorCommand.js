...
class CreateStreamProcessorCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateStreamProcessorRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateStreamProcessorResponse.filterSensitiveLog,
        };
