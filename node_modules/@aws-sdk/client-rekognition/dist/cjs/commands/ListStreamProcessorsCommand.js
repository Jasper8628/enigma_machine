...
class ListStreamProcessorsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListStreamProcessorsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListStreamProcessorsResponse.filterSensitiveLog,
        };
