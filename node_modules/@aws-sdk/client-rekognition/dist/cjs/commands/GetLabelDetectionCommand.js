...
class GetLabelDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetLabelDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetLabelDetectionResponse.filterSensitiveLog,
        };
