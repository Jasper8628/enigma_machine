...
class GetCelebrityInfoCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetCelebrityInfoRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetCelebrityInfoResponse.filterSensitiveLog,
        };
