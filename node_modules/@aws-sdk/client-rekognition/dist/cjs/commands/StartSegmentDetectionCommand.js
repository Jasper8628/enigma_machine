...
class StartSegmentDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartSegmentDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartSegmentDetectionResponse.filterSensitiveLog,
        };
