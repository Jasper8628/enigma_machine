...
class GetFaceDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetFaceDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetFaceDetectionResponse.filterSensitiveLog,
        };
