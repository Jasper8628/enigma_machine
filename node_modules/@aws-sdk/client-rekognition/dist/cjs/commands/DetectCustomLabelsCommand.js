...
class DetectCustomLabelsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DetectCustomLabelsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DetectCustomLabelsResponse.filterSensitiveLog,
        };
