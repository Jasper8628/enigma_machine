...
class StartCelebrityRecognitionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartCelebrityRecognitionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartCelebrityRecognitionResponse.filterSensitiveLog,
        };
