...
class DeleteCollectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteCollectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteCollectionResponse.filterSensitiveLog,
        };
