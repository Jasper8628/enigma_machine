...
class StartStreamProcessorCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartStreamProcessorRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartStreamProcessorResponse.filterSensitiveLog,
        };
