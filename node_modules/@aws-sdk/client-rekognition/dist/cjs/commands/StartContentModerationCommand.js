...
class StartContentModerationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartContentModerationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartContentModerationResponse.filterSensitiveLog,
        };
