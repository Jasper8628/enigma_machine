...
class GetPersonTrackingCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetPersonTrackingRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetPersonTrackingResponse.filterSensitiveLog,
        };
