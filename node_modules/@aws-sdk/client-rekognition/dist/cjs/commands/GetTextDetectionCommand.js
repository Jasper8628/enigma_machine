...
class GetTextDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetTextDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetTextDetectionResponse.filterSensitiveLog,
        };
