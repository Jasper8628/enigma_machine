...
class StartSpeechSynthesisTaskCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartSpeechSynthesisTaskInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartSpeechSynthesisTaskOutput.filterSensitiveLog,
        };
