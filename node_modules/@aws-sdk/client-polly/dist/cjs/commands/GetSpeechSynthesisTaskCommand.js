...
class GetSpeechSynthesisTaskCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetSpeechSynthesisTaskInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetSpeechSynthesisTaskOutput.filterSensitiveLog,
        };
