...
class ListSpeechSynthesisTasksCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListSpeechSynthesisTasksInput.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListSpeechSynthesisTasksOutput.filterSensitiveLog,
        };
