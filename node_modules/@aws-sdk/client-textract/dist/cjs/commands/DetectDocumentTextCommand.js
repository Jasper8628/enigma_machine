...
class DetectDocumentTextCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DetectDocumentTextRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DetectDocumentTextResponse.filterSensitiveLog,
        };
