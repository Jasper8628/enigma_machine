...
class GetDocumentTextDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetDocumentTextDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetDocumentTextDetectionResponse.filterSensitiveLog,
        };
