...
class StartDocumentAnalysisCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartDocumentAnalysisRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartDocumentAnalysisResponse.filterSensitiveLog,
        };
