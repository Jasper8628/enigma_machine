...
class StartDocumentTextDetectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartDocumentTextDetectionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartDocumentTextDetectionResponse.filterSensitiveLog,
        };
