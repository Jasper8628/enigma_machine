...
class GetDocumentAnalysisCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetDocumentAnalysisRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetDocumentAnalysisResponse.filterSensitiveLog,
        };
