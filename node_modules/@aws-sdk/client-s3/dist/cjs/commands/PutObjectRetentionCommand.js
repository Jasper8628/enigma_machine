...
class PutObjectRetentionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.PutObjectRetentionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.PutObjectRetentionOutput.filterSensitiveLog,
        };
