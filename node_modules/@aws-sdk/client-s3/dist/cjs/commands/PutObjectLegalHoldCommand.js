...
class PutObjectLegalHoldCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.PutObjectLegalHoldRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.PutObjectLegalHoldOutput.filterSensitiveLog,
        };
