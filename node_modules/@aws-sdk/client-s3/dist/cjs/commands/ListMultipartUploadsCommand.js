...
class ListMultipartUploadsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListMultipartUploadsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListMultipartUploadsOutput.filterSensitiveLog,
        };
