...
class GetBucketVersioningCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetBucketVersioningRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetBucketVersioningOutput.filterSensitiveLog,
        };
