...
class GetObjectLockConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetObjectLockConfigurationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetObjectLockConfigurationOutput.filterSensitiveLog,
        };
