...
class GetBucketLocationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetBucketLocationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetBucketLocationOutput.filterSensitiveLog,
        };
