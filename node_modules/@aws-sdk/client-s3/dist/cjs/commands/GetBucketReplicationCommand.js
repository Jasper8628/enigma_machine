...
class GetBucketReplicationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetBucketReplicationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetBucketReplicationOutput.filterSensitiveLog,
        };
