...
class ListObjectVersionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListObjectVersionsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListObjectVersionsOutput.filterSensitiveLog,
        };
