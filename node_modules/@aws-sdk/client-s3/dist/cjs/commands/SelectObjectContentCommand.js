...
class SelectObjectContentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.SelectObjectContentRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.SelectObjectContentOutput.filterSensitiveLog,
        };
