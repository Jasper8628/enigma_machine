...
class GetBucketEncryptionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetBucketEncryptionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetBucketEncryptionOutput.filterSensitiveLog,
        };
