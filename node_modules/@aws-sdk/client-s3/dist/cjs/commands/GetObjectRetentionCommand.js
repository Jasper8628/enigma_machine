...
class GetObjectRetentionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetObjectRetentionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetObjectRetentionOutput.filterSensitiveLog,
        };
