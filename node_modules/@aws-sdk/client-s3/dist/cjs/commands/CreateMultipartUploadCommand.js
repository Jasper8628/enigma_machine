...
class CreateMultipartUploadCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateMultipartUploadRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateMultipartUploadOutput.filterSensitiveLog,
        };
