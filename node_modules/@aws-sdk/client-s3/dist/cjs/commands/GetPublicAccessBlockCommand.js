...
class GetPublicAccessBlockCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetPublicAccessBlockRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetPublicAccessBlockOutput.filterSensitiveLog,
        };
