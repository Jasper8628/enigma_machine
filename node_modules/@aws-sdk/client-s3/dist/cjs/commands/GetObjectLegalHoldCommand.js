...
class GetObjectLegalHoldCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.GetObjectLegalHoldRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.GetObjectLegalHoldOutput.filterSensitiveLog,
        };
