...
class DescribeEndpointCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeEndpointRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeEndpointResponse.filterSensitiveLog,
        };
