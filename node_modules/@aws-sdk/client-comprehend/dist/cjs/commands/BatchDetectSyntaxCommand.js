...
class BatchDetectSyntaxCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.BatchDetectSyntaxRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.BatchDetectSyntaxResponse.filterSensitiveLog,
        };
