...
class StartSentimentDetectionJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartSentimentDetectionJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartSentimentDetectionJobResponse.filterSensitiveLog,
        };
