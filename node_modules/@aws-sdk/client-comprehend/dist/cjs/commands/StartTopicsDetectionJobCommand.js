...
class StartTopicsDetectionJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartTopicsDetectionJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartTopicsDetectionJobResponse.filterSensitiveLog,
        };
