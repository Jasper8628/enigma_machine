...
class DescribeEntityRecognizerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeEntityRecognizerRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeEntityRecognizerResponse.filterSensitiveLog,
        };
