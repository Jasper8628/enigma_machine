...
class CreateEntityRecognizerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateEntityRecognizerRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateEntityRecognizerResponse.filterSensitiveLog,
        };
