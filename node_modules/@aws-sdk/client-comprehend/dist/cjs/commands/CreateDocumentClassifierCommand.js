...
class CreateDocumentClassifierCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.CreateDocumentClassifierRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.CreateDocumentClassifierResponse.filterSensitiveLog,
        };
