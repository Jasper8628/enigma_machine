...
class ListSentimentDetectionJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListSentimentDetectionJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListSentimentDetectionJobsResponse.filterSensitiveLog,
        };
