...
class ListDocumentClassifiersCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListDocumentClassifiersRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListDocumentClassifiersResponse.filterSensitiveLog,
        };
