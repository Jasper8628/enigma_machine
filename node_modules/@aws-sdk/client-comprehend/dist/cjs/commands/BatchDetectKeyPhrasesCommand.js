...
class BatchDetectKeyPhrasesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.BatchDetectKeyPhrasesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.BatchDetectKeyPhrasesResponse.filterSensitiveLog,
        };
