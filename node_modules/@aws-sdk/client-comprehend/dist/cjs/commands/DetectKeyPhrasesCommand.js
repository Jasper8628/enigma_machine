...
class DetectKeyPhrasesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DetectKeyPhrasesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DetectKeyPhrasesResponse.filterSensitiveLog,
        };
