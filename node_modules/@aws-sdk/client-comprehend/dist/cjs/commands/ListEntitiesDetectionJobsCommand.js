...
class ListEntitiesDetectionJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListEntitiesDetectionJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListEntitiesDetectionJobsResponse.filterSensitiveLog,
        };
