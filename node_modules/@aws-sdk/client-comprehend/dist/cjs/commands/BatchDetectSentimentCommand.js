...
class BatchDetectSentimentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.BatchDetectSentimentRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.BatchDetectSentimentResponse.filterSensitiveLog,
        };
