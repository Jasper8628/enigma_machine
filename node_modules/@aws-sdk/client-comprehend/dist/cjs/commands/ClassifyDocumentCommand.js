...
class ClassifyDocumentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ClassifyDocumentRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ClassifyDocumentResponse.filterSensitiveLog,
        };
