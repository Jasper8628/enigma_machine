...
class DescribeDocumentClassificationJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeDocumentClassificationJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeDocumentClassificationJobResponse.filterSensitiveLog,
        };
