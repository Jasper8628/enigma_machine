...
class StartDominantLanguageDetectionJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartDominantLanguageDetectionJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartDominantLanguageDetectionJobResponse.filterSensitiveLog,
        };
