...
class DetectDominantLanguageCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DetectDominantLanguageRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DetectDominantLanguageResponse.filterSensitiveLog,
        };
