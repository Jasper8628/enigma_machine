...
class BatchDetectEntitiesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.BatchDetectEntitiesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.BatchDetectEntitiesResponse.filterSensitiveLog,
        };
