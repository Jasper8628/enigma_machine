...
class StopTrainingEntityRecognizerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StopTrainingEntityRecognizerRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StopTrainingEntityRecognizerResponse.filterSensitiveLog,
        };
