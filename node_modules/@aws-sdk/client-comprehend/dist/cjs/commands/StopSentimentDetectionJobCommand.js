...
class StopSentimentDetectionJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StopSentimentDetectionJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StopSentimentDetectionJobResponse.filterSensitiveLog,
        };
