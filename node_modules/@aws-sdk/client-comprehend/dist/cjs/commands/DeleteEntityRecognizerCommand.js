...
class DeleteEntityRecognizerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteEntityRecognizerRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteEntityRecognizerResponse.filterSensitiveLog,
        };
