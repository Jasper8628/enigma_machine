...
class BatchDetectDominantLanguageCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.BatchDetectDominantLanguageRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.BatchDetectDominantLanguageResponse.filterSensitiveLog,
        };
