...
class DescribeTopicsDetectionJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeTopicsDetectionJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeTopicsDetectionJobResponse.filterSensitiveLog,
        };
