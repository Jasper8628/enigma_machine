...
class ListDocumentClassificationJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListDocumentClassificationJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListDocumentClassificationJobsResponse.filterSensitiveLog,
        };
