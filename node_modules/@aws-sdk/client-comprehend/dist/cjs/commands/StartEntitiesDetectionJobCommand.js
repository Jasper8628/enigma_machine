...
class StartEntitiesDetectionJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartEntitiesDetectionJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartEntitiesDetectionJobResponse.filterSensitiveLog,
        };
