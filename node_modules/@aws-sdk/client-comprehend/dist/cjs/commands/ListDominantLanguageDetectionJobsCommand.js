...
class ListDominantLanguageDetectionJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListDominantLanguageDetectionJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListDominantLanguageDetectionJobsResponse.filterSensitiveLog,
        };
