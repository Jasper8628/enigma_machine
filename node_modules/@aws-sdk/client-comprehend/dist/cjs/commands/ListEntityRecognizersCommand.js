...
class ListEntityRecognizersCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListEntityRecognizersRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListEntityRecognizersResponse.filterSensitiveLog,
        };
