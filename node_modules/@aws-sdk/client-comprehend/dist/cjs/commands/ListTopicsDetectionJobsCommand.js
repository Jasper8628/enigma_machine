...
class ListTopicsDetectionJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListTopicsDetectionJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListTopicsDetectionJobsResponse.filterSensitiveLog,
        };
