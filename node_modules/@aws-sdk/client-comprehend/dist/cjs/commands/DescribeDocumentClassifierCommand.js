...
class DescribeDocumentClassifierCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeDocumentClassifierRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeDocumentClassifierResponse.filterSensitiveLog,
        };
