...
class DeleteDocumentClassifierCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DeleteDocumentClassifierRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DeleteDocumentClassifierResponse.filterSensitiveLog,
        };
