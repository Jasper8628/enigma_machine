...
class StopTextTranslationJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StopTextTranslationJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StopTextTranslationJobResponse.filterSensitiveLog,
        };
