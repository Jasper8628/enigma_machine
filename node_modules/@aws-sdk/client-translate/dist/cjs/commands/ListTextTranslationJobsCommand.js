...
class ListTextTranslationJobsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.ListTextTranslationJobsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.ListTextTranslationJobsResponse.filterSensitiveLog,
        };
