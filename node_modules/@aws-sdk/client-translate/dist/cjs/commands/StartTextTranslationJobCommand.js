...
class StartTextTranslationJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.StartTextTranslationJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.StartTextTranslationJobResponse.filterSensitiveLog,
        };
