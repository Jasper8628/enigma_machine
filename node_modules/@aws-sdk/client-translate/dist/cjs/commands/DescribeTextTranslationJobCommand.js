...
class DescribeTextTranslationJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            logger,
            inputFilterSensitiveLog: index_1.DescribeTextTranslationJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: index_1.DescribeTextTranslationJobResponse.filterSensitiveLog,
        };
